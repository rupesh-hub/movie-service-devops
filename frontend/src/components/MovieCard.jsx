    ...
    return (
        <Link to="/details">
            <div className="movie-card w-40 relative group cursor-pointer">
                ...
                <div
                    className="absolute bottom-0 left-0 right-0 p-2 bg-gradient-to-t from-black/80 to-transparent rounded-b-lg">
                    <h5 className="text-md font-semibold text-white truncate text-center font-serif">
                        {movie.title}
                    </h5>
